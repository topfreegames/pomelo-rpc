...
var jaeger = require('../jaeger/tracer');
...
pro.rpcInvoke = function(serverId, msg, cb) {
  ...
  var parent = jaeger.currentSpan();
  var originCb = cb;

  tracer.span = parent.startSpan(msg.service + '::' + msg.method, {
    'pomelo.source': this.opts.clientId,
    'pomelo.remote': serverId,
    'span.kind': 'client'
  });

  cb = function(err) {
    var args = arguments;
    tracer.span.finish(err);
    parent.propagate(function() {
      utils.applyCallback(originCb, args);
    });
  };
